                ...
                {payments.map((item) => (
                  <tr key={item._id}>
                    ...
                    <td className='name-column1'>
                      ₦{(item.amount * 0.95).toFixed(2)} {/* Deduct 5% from amount */}
                    </td>
                    <td className='name-column1'>
                      {new Date(item.paymentDate).toLocaleDateString()} {/* Display date */}
                    </td>
                    <td className='name-column1'>
                      {item.status} {/* Display status */}
                    </td>
                    <td className='name-column1'>
                      {new Date(item.paymentDate).toLocaleTimeString()} {/* Display time */}
                    </td>
                  </tr>
                ))}
              </tbody>
