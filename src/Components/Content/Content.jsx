...
scheduled in advance to ensure on-time delivery.</p>
            <div className="content-btn">Get Started</div></div>
...
hidden fees or a minimum number of units.</p>
            <div className="content-btn">Expolre</div></div>
       </div>
        <div className="content">
          <div className="content-block">
            <h5>Protect Your Privacy</h5>
            <p>Rent wave is a secure way to accept electronic rent payments
while maintaining privacy and safety. Accept credit cards or
bank transfers from any U.S-based bank or credit union
without giving away any personal information to tenants.</p>
            <div className="content-btn">Click Here</div></div>
...
when they pay on time.</p>
            <div className="content-btn">Join</div></div>
          </div>
      <div className="content-down">
        ...
        <div className="content-btn" style={{width: "20%"}}>Get Started</div>
      </div>
    </div>
  )
}
